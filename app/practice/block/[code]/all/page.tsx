...
export function generateMetadata({ params }: { params: { code: string } }) {
  ...
  return { title: s ? `Practice: ${s.code} (whole block) — WilliamsHub` : 'Practice — WilliamsHub' };
}
    ...
    <main className="mx-auto max-w-3xl px-5 py-8">
      ...
      <header className="mb-6 mt-4">
        ...
        <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-[#1e5bd6] dark:text-[#7AA0FF]">
          <span>Practice · whole block</span>
        ...
        <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
          ...
          session serves 20 random questions spanning lectures, traps and cross-links.
        </p>
      </header>
