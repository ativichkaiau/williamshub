...
export const ghpFetalCirculationGrowth: Lecture = {
  ...
  mechanism: {
    ...
    steps: [
      ...
      { id: 's2', label: 'A substantial share — often about 20 to 30 per cent, varying with gestation — is jetted past the liver through the ductus venosus into the inferior vena cava at high velocity', detail: 'Velocity is the point: a coherent jet resists mixing and can therefore be aimed.' },
